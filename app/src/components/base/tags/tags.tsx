...
export const Tag = ({
    ...
    return (
        <AriaTag
            ...
            className={(state) =>
                cx(
                    "flex cursor-default items-center gap-0.75 rounded-md bg-uui-primary text-uui-secondary ring-1 ring-uui-primary outline-focus-ring transition duration-50 ease-linear ring-inset focus-visible:outline-2 focus-visible:outline-offset-2",
