...
export default function FundAccountLinkedPage() {
  return (
    <div className={s.shell}>
      ...
      <div className={s.successContainer}>
        <span className={s.checkCircle} aria-hidden="true">
          <svg viewBox="0 0 256 256" fill="none" stroke="currentColor" strokeWidth="20" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="40 144 96 200 224 72"/>
          </svg>
        </span>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, alignItems: 'center' }}>
          <h1 className={s.submittedTitle}>Account linked successfully</h1>
          <p className={s.submittedDesc}>Your funding source is connected and ready for deposits.</p>
        </div>

        <Link href="/onboarding/fund-amount" className={s.cta} style={{ textDecoration: 'none' }}>
          Set deposit amount
