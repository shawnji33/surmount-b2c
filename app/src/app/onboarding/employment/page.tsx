...
export default function EmploymentPage() {
  ...
  return (
    <OnboardingFlow back="/onboarding/verify-phone">
      <main className={s.main}>
        <div className={s.stack}>
          <div className={s.hero}>
            <h1 className={s.title}>What&apos;s your employment status?</h1>
          </div>

          <div className={s.radioGroup} role="radiogroup" aria-label="Employment status">
            {OPTIONS.map(opt => (
              <button
                key={opt.value}
                type="button"
