...
// Duplicate of /onboarding/choose-your-plan, wired to the checklist-page exploration
// (/home/get-started) instead of the real onboarding flow, so this demo doesn't touch the
// production pricing page. Reached from the "Connect an external account" modal's "Choose a
// plan" action — see ../_components/ConnectExternalModal.tsx.
...
export default function GetStartedChoosePlanPage() {
