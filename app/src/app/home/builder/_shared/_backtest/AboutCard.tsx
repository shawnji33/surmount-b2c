...
import type { AboutStats, AllocationRow, BreakdownGroup } from '../types';
import bt from '../BacktestPanel.module.css';
  ...
  return (
    <div className={s.card}>
      ...
      <div className={s.body}>
        <div key={view} className={[s.chartCol, s.swapIn].join(' ')}>
        ...
        <div key={`${view}-list`} className={[s.list, s.swapIn].join(' ')}>
          {groups.map((g, i) => (
            ...
            >
              <span className={s.dot} style={{ background: breakdownColor(i) }} />
