...
const SECTIONS = [
  ...
  },
  {
    ...
    routes: [
      ...
      { href: '/home?state=empty', label: 'Investing home — empty (no account yet)' },
      { href: '/home?state=empty&connected=kraken', label: 'Investing home — empty (just connected)' },
      { href: '/home/get-started', label: 'Get started — checklist page exploration ★' },
      { href: '/home/get-started/plans', label: 'Get started — choose a plan (demo duplicate) ★' },
      { href: '/home/saving', label: 'Saving home' },
      { href: '/home/strategy/quantum-computing-leaders', label: 'Strategy detail' },
      { href: '/home/builder', label: 'Create — strategy list + choose-a-builder modal' },
      { href: '/home/builder/etf', label: 'Create — ETF Builder (asset picker, allocation, rules, backtest)' },
      { href: '/home/builder/no-code', label: 'Create — No-Code Builder (adds visual logic canvas)' },
      { href: '/home/builder/code', label: 'Create — builder placeholder (Code Builder)' },
      { href: '/home/builder/promptfolio', label: 'Create — builder placeholder (Promptfolio)' },
  ...
  },
  {
    ...
    routes: [
      ...
      { href: '/home/playground/agent-home/a', label: 'Agent home — A: Chat-first minimal' },
      { href: '/home/playground/agent-home/b', label: 'Agent home — B: Chat + Agents balanced' },
      { href: '/home/playground/agent-home/c', label: 'Agent home — C: Split panel' },
      { href: '/home/playground/agent-home/d', label: 'Agent home — D: State-adaptive (toggle inside)' },
      { href: '/home/playground/glass-demo', label: 'Glass surface demo — .glass-surface utility (circle/pill/card)' },
    ],
  },
  {
    label: 'Onboarding — Start',
    routes: [
      { href: '/onboarding/email-link', label: 'Verification email (simulated inbox — click link)' },
      { href: '/onboarding/verifying', label: 'Verifying account (email-link splash)' },
      { href: '/onboarding/welcome', label: 'Welcome (centered card, animated entrance)' },
      { href: '/onboarding/tour-2', label: 'Product tour 1 of 3 (Promptfolio + no-code builder)' },
      { href: '/onboarding/tour', label: 'Product tour 2 of 3 (strategies do the work)' },
      { href: '/onboarding/tour-3', label: 'Product tour 3 of 3 (Easy to invest — brokerages + Surmount account)' },
      { href: '/onboarding/choose-plan', label: 'Choose plan (start free vs paid)' },
      { href: '/onboarding/all-set', label: 'All set (free path → home)' },
      { href: '/onboarding/choose-your-plan', label: 'Choose your plan (paid tiers: Core/Plus/Pro)' },
      { href: '/onboarding/checkout?tier=plus', label: 'Checkout (mock Stripe payment)' },
      { href: '/home?state=empty&unlocked=core', label: '"You\'ve unlocked" modal — Core (empty dashboard)' },
      { href: '/home?state=empty&unlocked=plus', label: '"You\'ve unlocked" modal — Plus (empty dashboard)' },
      { href: '/home?state=empty&unlocked=pro', label: '"You\'ve unlocked" modal — Pro (empty dashboard)' },
  ...
  },
  {
    ...
    routes: [
      ...
      { href: '/onboarding/documents-rejected', label: 'Documents rejected' },
    ],
  },
  {
    // Post-application progress tracking. Case 1 of several: the user submitted
    // an application but never finished identity verification, and re-enters
    // from the dashboard card to resume.
    label: 'Account progress — resume application',
    routes: [
      { href: '/onboarding/application-status', label: "Almost ready to invest (hub)" },
      { href: '/onboarding/application-status/verify-identity', label: 'Verify identity — upload' },
      { href: '/onboarding/application-status/documents-received', label: 'Documents received' },
    ],
  },
  {
